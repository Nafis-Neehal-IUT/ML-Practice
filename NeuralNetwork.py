...
class NeuralNetwork:
	...
	def structure_define(self):
		...
		hidden_layer_1 = Layer([self.hidden_units, 'ReLU', hidden_layer_1_weights, hidden_layer_1_biases])
		...
		hidden_layer_2 = Layer([self.hidden_units, 'ReLU', hidden_layer_2_weights, hidden_layer_2_biases])
